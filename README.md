...
If you want the older versions of the engine (or if you wanna use a more updated psych engine):
* [**PE 0.6.3 (PFE 0.1)**](https://github.com/ClassicBoost/Psych-Forever/tree/0.6.3-Legacy) - Late 2022
  * Usually the go to if you want a more modern Psych Engine, be aware that it's not as great as this.
...
## Character Editor
* The characters can now support winning icons. (though not required)
