...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		rating = new FlxSprite().loadGraphic(Paths.image('UI/base/sick'));
		...
		timeBar = new HealthBar(0, timeTxt.y + (timeTxt.height / 3), 'UI/healthBar', function() return barPercent, delayMin, delayMax);
