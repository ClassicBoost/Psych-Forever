...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		// IGNORE THIS!!!
		titleJSON = Json.parse(Paths.getTextFromFile('images/menus/gfDanceTitle.json'));
	...
	function startIntro()
	{
		...
		var path = "mods/" + Paths.currentModDirectory + "/images/menus/titleEnter.png";
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
			path = "mods/images/menus/titleEnter.png";
		}
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
			path = "assets/images/menus/titleEnter.png";
		}
		//trace(path, FileSystem.exists(path));
