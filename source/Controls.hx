...
class Controls extends FlxActionSet
{
	...
	public var CHART(get, never):Bool;
	...
	inline function get_BOTPLAY()
		return _botplay.check();

	public var PRACTICE(get, never):Bool;

	inline function get_PRACTICE()
		return _practice.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case BOTPLAY:
				func(_botplay, JUST_PRESSED);
			case PRACTICE:
				func(_practice, JUST_PRESSED);
