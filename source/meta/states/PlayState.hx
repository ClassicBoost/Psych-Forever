...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'spooky': //Week 2
				...
				//PRECACHE SOUNDS
				CoolUtil.precacheSound('others/thunder_1');
				CoolUtil.precacheSound('others/thunder_2');
			...
			case 'philly': //Week 3
				...
				trainSound = new FlxSound().loadEmbedded(Paths.sound('others/train_passes'));
				CoolUtil.precacheSound('others/train_passes');
			...
			case 'limo': //Week 4
				...
				if(!ClientPrefs.lowQuality) {
					...
					//PRECACHE SOUND
					CoolUtil.precacheSound('others/dancerdeath');
				}
	...
	function missedNote(longNote:Bool = false, ?countForMiss:Bool = true, ?shitRating:Bool = false) {
		if (!shitRating || health > 0.06) health -= 0.06; //For testing purposes
		missedLongNote = true;
