...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		...
		["What a Funkin' Disaster!",	"Complete a Song with a accuracy lower than 40%.",		false],
		["Perfectionist",				"Complete a Song with a 100% accuracy.",				false],
		["Roadkill Enthusiast",			"Watch the Henchmen die 50 times.",						false],
...
class AttachedAchievement extends FlxSprite {
	...
	public function new(x:Float = 0, y:Float = 0, id:Int = 0) {
		...
		if(Achievements.achievementsUnlocked[id][1]) {
			loadGraphic(Paths.image('menus/awards/achievementgrid'), true, 150, 150);
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(id:Int, ?camera:FlxCamera = null)
	{
		...
		var achievementIcon:FlxSprite = new FlxSprite(achievementBG.x + 10, achievementBG.y + 10).loadGraphic(Paths.image('menus/awards/achievementgrid'), true, 150, 150);
