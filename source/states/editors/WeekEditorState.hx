...
class WeekEditorState extends MusicBeatState
{
	...
	function reloadBG() {
		...
		if(assetName != null && assetName.length > 0) {
			...
			Assets.exists(Paths.getPath('images/menus/story/backgrounds/' + assetName + '.png', IMAGE), IMAGE)) {
	...
	function reloadWeekThing() {
		...
		if(assetName != null && assetName.length > 0) {
			...
			Assets.exists(Paths.getPath('images/menus/story/weeks/' + assetName + '.png', IMAGE), IMAGE)) {
