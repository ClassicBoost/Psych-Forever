...
class Spooky extends BaseStage
{
	...
	override function create()
	{
		if(!ClientPrefs.data.lowQuality) {
			halloweenBG = new BGSprite('backgrounds/halloween/halloween_bg', -200, -100, ['halloweem bg0', 'halloweem bg lightning strike']);
		} else {
			halloweenBG = new BGSprite('backgrounds/halloween/halloween_bg_low', -200, -100);
		}
		add(halloweenBG);
