...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["What a Funkin' Disaster!",	"Complete a Song with a accuracy lower than 50%.",	'ur_bad',				false],
		...
		["The No Anti-Masher",			"Did you FC by mashing?",							'masher',				false],
		["Lets abuse it while we can", 	"Miss 80% of the song's long notes", 				"long_misser",			 true],
